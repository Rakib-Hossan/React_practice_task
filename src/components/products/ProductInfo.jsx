        ...
        <div className="hero">
            <div className="hero-content gap-12 flex-col-2">
                ...
                <div className="flex-1 md:px-10 ">
                  <h1 className=" text-3xl md:text-xl text-violet-600 font-bold ">{product?.title} <div className="badge badge-secondary px-4 py-3">{product?.category}</div></h1>
                  <p className="py-6 font-semibold">{product?.tagline}</p>
                  <p className="py-6 text-zinc-700">{product?.description}</p>
